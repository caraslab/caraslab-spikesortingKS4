function caraslab_preprocessdat(root_path, inspect_artifact_removal_only)
...
%     NT       = ops.NT ; % number of timepoints per batch
    ...
    if isfield(ops,'fslow') && ops.fslow<ops.fs/2
        ...
        [b1, a1] = butter(3, getOr(ops, 'fshigh', 300) /ops.fs*2, 'high'); % the default is to only do high-pass filtering at 150Hz
    end
