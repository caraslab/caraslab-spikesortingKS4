...
for folder_idx = 1:numel(datafolders)
    ...
    optoTimestamps_targetSource_path =       {fullfile(parent_path, 'Data', 'Key files'), ...
                                            fullfile(cur_bin_path, 'Info files', '*optoTimestamps.csv')};
	...
	all_paths = {breakpoints_targetSource_paths, ...
        trialInfo_targetSource_path, spoutTimestamps_targetSource_path, optoTimestamps_targetSource_path, qualityMetrics_targetSource_path, shankWaveform_targetSource_path, ...
